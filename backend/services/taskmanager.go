...
// GetUserTasks 获取用户任务列表（新增方法）
func (tm *TaskManager) GetUserTasks(userID string, limit, offset int) ([]*models.Task, error) {
	return database.GetUserTasks(userID, limit, offset)
}
