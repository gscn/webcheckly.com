...
func CreateOrderHandler(c *fiber.Ctx) error {
	...
	case "single_scan":
		...
		// 使用积分成本作为订单金额（1积分=1元）
		orderAmount := float64(pricing.CreditsCost)
		order, err = services.CreateOrder(userID.String(), models.OrderTypeSingleScan, req.Feature, orderAmount, req.PaymentMethod)
