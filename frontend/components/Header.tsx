      ...
      <div className="flex justify-between items-center py-4 px-6 max-w-7xl mx-auto">
        ...
        <nav className="hidden md:flex items-center gap-6">
          <ul className="flex items-center space-x-10 text-xs font-bold font-sans text-gray-300/80">
            ...
            <li>
              <Link href="/deep-scan" className="hover:text-tech-cyan hover:shadow-neon-cyan transition-all duration-300 flex items-center gap-1 group">
                <span className="text-tech-cyan/50 opacity-0 group-hover:opacity-100 transition-opacity">/</span> {t("nav.deepCheck")}
              </Link>
            </li>
            <li>
